...
#python responsetime.py $target  1>./$pre/$target.resp.time 2>./$pre/$target.resp.time.err
#python responsetime.py $target2  1>./$pre/$target2.resp.time 2>./$pre/$target2.resp.time.err
...
python avgresptime.py ./$pre/pkg2atime.thatpoint.$target.s dplyrVSHmisc/$target.resp.time.s dplyrVSHmisc/$target2.resp.time.s 1>./$pre/avgresptime.$target 2>./$pre/avgresptime.$target.err
python avgresptime.py ./$pre/pkg2atime.thatpoint.$target2.s dplyrVSHmisc/$target.resp.time.s dplyrVSHmisc/$target2.resp.time.s 1>./$pre/avgresptime.$target2 2>./$pre/avgresptime.$target2.err
